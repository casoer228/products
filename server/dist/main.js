...
const request_injectior_interceptor_1 = require("./providers/request-injectior.interceptor");
var NodeEnv;
(function (NodeEnv) {
...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        app.useGlobalInterceptors(new request_injectior_interceptor_1.RequestInjectorInterceptor());
